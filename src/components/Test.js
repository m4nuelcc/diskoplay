         ...
         rendergrupo = () => {
           return (
             <input
               ...
               onChange={c => {
                 this.setState({
                   datos: { ...this.state.datos, grupo: c.target.value }
                 });
               }}
             />
           );
         ...
         renderdisko = () => {
           return (
             <input
               ...
               onChange={c => {
                 this.setState({
                   datos: { ...this.state.datos, disko: c.target.value }
                 });
               }}
             />
           );
         ...
         renderprecio = () => {
           return (
             <input
               ...
               onChange={c => {
                 this.setState({
                   datos: { ...this.state.datos, precio: c.target.value }
                 });
               }}
             />
           );
